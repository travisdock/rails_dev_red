class CreditsScene extends Phaser.Scene {
  ...
  create() {
    ...
    const entries = [
      ...
      { text: 'Stephen McKeon', size: 8 },
      { text: 'Irina Nazarova', size: 8 },
      { text: 'Nadia Odunayo', size: 8 },
      { text: 'Chris Oliver', size: 8 },
      { text: 'Amanda Perino', size: 8 },
      { text: 'Ifat Ribon', size: 8 },
      { text: 'Matheus Richard', size: 8 },
      { text: 'Jeremy Smith', size: 8 },
      { text: 'Nikky Southerland', size: 8 },
      { text: 'Aaron Wallentine', size: 8 },
      { text: 'Scott Werner', size: 8 },
      { text: 'Rachael Wright-Munn', size: 8 },
      { text: '', size: 8 },
